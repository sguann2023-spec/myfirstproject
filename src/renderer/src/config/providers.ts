...
export const MODEL_PREFIX_PROVIDER_HINTS: ReadonlyArray<{
  prefixes: readonly string[]
  preferredProviderId: SystemProviderId
}> = [
  { prefixes: ['gpt-'], preferredProviderId: 'openai' },
  { prefixes: ['claude-'], preferredProviderId: 'anthropic' },
  { prefixes: ['qwen-', 'qvq-', 'qwq-'], preferredProviderId: 'bailian' },
  { prefixes: ['gemini-'], preferredProviderId: 'gemini' }
]
