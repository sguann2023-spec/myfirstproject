...
const items: SkillCatalogItem[] = [
  {
    id: 'qq-music-assistant', name: 'QQ音乐助手',
  ...
  {
    id: 'east-money-search', name: '东方财富搜索',
  ...
  {
    id: 'xiaohongshu-copywriter', name: '小红书笔记创作',
  ...
  {
    id: 'children-picture-book', name: '儿童绘本',
