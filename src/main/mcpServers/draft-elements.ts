  ...
  toolWithArgs(
    ...
    'Add a single preset segment into a VectCut draft. Use this when the user already has a preset_id and wants to replace text, image, video, or audio placeholders.',
    {
      ...
      replacements: {
        ...
        description: 'Optional replacement list. Each item is an object mapping preset placeholder keys such as text1/image1/video1/audio1 to replacement string values.'
      },
