export enum IpcChannel {
  ...
  App_SendFeedbackEmail = 'app:send-feedback-email',
  ...
  CherryChatStream_Abort = 'cherry-chat-stream:abort',
  CherryChatStream_Chunk = 'cherry-chat-stream:chunk',
  ...
  Skill_CopyDirectoryToWorkspace = 'skill:copy-directory-to-workspace',
  ...
  Skill_RunExample = 'skill:run-example',
