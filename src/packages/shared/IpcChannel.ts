export enum IpcChannel {
  ...
  App_Quit = 'app:quit',
  App_Info = 'app:info',
  App_GetVectcutApiKey = 'app:get-vectcut-api-key',
  App_Proxy = 'app:proxy',
  ...
  Skill_InstallFromRemotePackage = 'skill:install-from-remote-package',
  Skill_UpdateMetadata = 'skill:update-metadata',
