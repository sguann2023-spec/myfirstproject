...
4. `generate_speech` + `add_audio`：生成配音并写回草稿，配音 `volume=20`，默认音色 `voice_id=gv_8195cd8b03f74658a9d92c9b2a9e9cba`。
...
- `generate_speech` 默认使用：`voice_id=gv_8195cd8b03f74658a9d92c9b2a9e9cba`。
